<template>
  <div>
    <!-- Boutton compteur de likes -->
    <!-- Boutton sur le "like" pour voir qui à liké -->
    <button
    ...
    <!-- Affichage des détails PP + Nom et prénom de la personne qui à liké -->
    <b-modal :id="`modal-likes-${post.id}`" :title="`${likesCount}`">
